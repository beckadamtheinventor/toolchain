...
//    real& operator%=(const real& rhs) { value = os_RealFrac(&value); return *this; }
...
//    real fmod(const real& y) const { return *this % y; }
//    real remainder(const real& y) const {}
//    real remquo(const real& y, int* quo) const {}
//    real fma(const real& y, const real& z) const {}
...
//    real exp2() const { return make_real<2>().pow(*this); }
...
//    real cbrt() const {}
//    real hypot(const real& y) const {}
//    real hypot(const real& y, const real& z) const {}
